        ...
        <form class="leading-loose flex flex-col gap-3 w-[100%]">
          ...
          <div class="py-3 px-3 lg:px-8">
                ...
                <form class="space-y-3" action="#">
                    ...
                    <button type="submit" class="w-full text-white bg-pink-400 hover:bg-pink-600 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-pink-600">Login to your account</button>
